    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
 		...
 		<li><a href='../personal.php?action=logout'>Log Out</a> </li>       </ul>
      </div>
      <div class="clr"></div>
    </div>
  </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h3>>>><a href='imgpost.php'>Post a picture</a></h3>
          <div class="clr"></div>
	         <div class="login">
...
<?php
			include('../conn.php');
			$result = mysql_query("select * from gallery where Name='$name' order by ID DESC");
