...
<!-- CuFon ends -->
	...
	<?php
		...
		{
			include('conn.php');
			$yourName = htmlspecialchars($_POST['searchForm2']);
			echo "<p>Result-Search by Name:  ";
			echo 	$yourName. "</p>";
			$sql_select="SELECT * FROM meeting where WorkPrst like '%" . $yourName . "%' or JnoPrstWorkshop like '%". $yourName . "%'";
