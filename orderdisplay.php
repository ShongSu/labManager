  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2><span>Product Order Management</span></h2>
            <div class="clr"></div>
     		<p class="meeting"> 
	<?php
		function search()
...
//			echo $sechyear."<br />".$sechweek."<br />".$sechname;
			...
			$statm="SELECT * FROM product WHERE Owner='$orderedby' AND Date Between '$fromdate' and '$todate' order by Date DESC";
