  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2><span>Cancel</span></h2><div class="clr"></div>
     		<p class="meeting"> 

	<?php
	$rowid=$_GET['ID'];
	include('conn.php');
	$result = mysql_query("select * from meeting where Id_M = '$rowid'");
	...
	echo "
	<table broder='0'>
	<form action='meetingdeleteop.php' method='POST'>
	<input type='hidden' name='ID' value='$rowid' />
	<tr id='special'>
	<td id='special'><span>Date:</span></td>
	<td id='special'><input type='date' name='Date' disabled='disabled'  value='$rowDates'  /></td>
	</tr>
	<tr id='special'>
	<td id='special'><span>Work Presentation:</span></td>
	<td id='special'><input type='text' name='WorkPrst' disabled='disabled'  value='$rowWorkPrst'  /></td>
	</tr>
	<tr id='special'>
	<td id='special'><span>Journal Presentation / Workshop:</span></td>
	<td id='special'><input type='text' name='JnoPrstWorkshop' disabled='disabled'  value='$rowJnoPrstWorkshop'  /></td>
	</tr>
	<tr id='special'>
	<td id='special'><span>Venue:</span></td>
	<td id='special'><input type='text' name='Venue' disabled='disabled'  value='$rowVenue'  /></td>
	</tr>
	<tr id='special'>
	<td id='special'><span>Start:</span></td>
	<td id='special'><input type='time' name='StartTime' disabled='disabled'  value='$rowStartTime'  /></td>
	</tr>
	<tr id='special'>
	<td id='special'><span>End:</span></td>
	<td id='special'><input type='time' name='EndTime' disabled='disabled'   value='$rowEndTime'  /></td>
	";
			?>	
	</tr>
	<tr id='special'>
	<td id='special'><input type='submit' onclick='return confirm("Are you confirm to cancel this meeting?")' name='submit' value='Delete'  /></td>
