  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2><span>Post your activity here</span></h2><div class="clr"></div>
	         <div class="login">
			...
			<p><strong>Title: </strong><br />
				<input type='text' name='title' size='50' required="required" placeholder="Title" />
			<p><strong>Post: </strong><br />
				<textarea name='postcontent' rows="6" cols="50" required="required" placeholder="Post your message here."></textarea>
				<br />
