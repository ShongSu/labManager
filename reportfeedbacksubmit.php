...
/*	echo $rowdate."<br/>";
	...
	include('conn.php');
	$update = mysql_query("UPDATE report SET Feedback='$feedback' WHERE Name='$fbname' and Week='$fbweek' and Year='$fbyear'");
	if(mysql_affected_rows())
	{
         	    echo "<script language='javascript'> alert('The feedback has been added successfully .') </script> ";
         	    echo "<script language='javascript'> self.location='reportviewadmin.php'</script> ";
        }
        else
        {
