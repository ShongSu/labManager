...
<script type="text/javascript">
	function changeForm()
	{
		...
		var y=document.getElementById("searchType")
 		var z=document.getElementById("quriyform")

//		alert("New action: " + y.value)
		if(y.value=="byName")
		{
			x.type="text"
			x.value=" "
			z.action="fullmeeting2.php"
		}
		if(y.value=="byDate")
		{
			x.type="date"
			z.action="fullmeeting3.php"
		}
	}
</script>	
  ...
  <div class="content">
      ...
      <div class="mainbar">
        <div class="article">
          <h2>Figeys' Lab Meeting Schedule  </h2><div class="clr"></div>
			<form id="quriyform" action="fullmeeting2.php" method="POST" >
				<?php
				...
				?>
					...
					Search by  <select id="searchType" onchange="changeForm()">
					<option value="byName">Name</option>
					<option value="byDate">Date</option>
					</select>
					<input id="searchForm"  name="searchForm2" type="text" />
	...
	<?php
		...
		include('conn.php');
			...
			$result = mysql_query("SELECT * FROM meeting order by Date ASC");
