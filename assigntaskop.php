...
<?php
	...
	$Owner=$_POST['Assignto'];
	$Task=$_POST['Task'];
	$Project=$_POST['Project'];


	include('conn.php');
	$insert = mysql_query("INSERT INTO todolist (Owner, SetupDate, Content, Status, Createdby, Project) VALUES ('$Owner', '$SetupDate', '$Task', 'Setup', '$name', '$Project')");
